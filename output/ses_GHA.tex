...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Ghana, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{50 percent} while it is \textbf{43 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Ghana, the probability
  of survival of a child born today in the richest 20 percent of
  households is \textbf{94 percent} while it is \textbf{91 percent} for
...
\item
  \textbf{Expected Years of School.} In Ghana, a child in the richest 20
  percent of households who starts school at age 6 can expect to
  complete \textbf{8.7 years} of school by her 18th birthday while a
  child from the poorest 20 percent can expect to complete \textbf{7.4
...
\item
  ...
  of households in Ghana score \textbf{317} while those from the poorest
  20 percent score \textbf{307}, a gap of \textbf{9 points}. This gap is
  smaller than the typical gap across the 51 countries (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Ghana, the percentage
  of children in the top 20 percent of households who are not stunted is
  \textbf{92 percent} while it is \textbf{75 percent} among the poorest
  20 percent, a gap of \textbf{17} percentage points. This gap is
  smaller than the typical gap across the 51 countries (19 percentage
  points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_GHA} \end{flushright}
