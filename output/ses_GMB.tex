...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Gambia, The, the productivity
  as a future worker of a child born today in the richest 20 percent of
  households is \textbf{56 percent} while it is \textbf{42 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Gambia, The, the
  probability of survival of a child born today in the richest 20
  percent of households is \textbf{97 percent} while it is \textbf{93
...
\item
  \textbf{Expected Years of School.} In Gambia, The, a child in the
  richest 20 percent of households who starts school at age 6 can expect
  to complete \textbf{9 years} of school by her 18th birthday while a
  child from the poorest 20 percent can expect to complete \textbf{6.3
  years} of school, a gap of \textbf{2.7 years} of school. This gap is
...
\item
  ...
  of households in Gambia, The score \textbf{402} while those from the
  poorest 20 percent score \textbf{332}, a gap of \textbf{71 points}.
  This gap is larger than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Gambia, The, the
  percentage of children in the top 20 percent of households who are not
  stunted is \textbf{85 percent} while it is \textbf{72 percent} among
  the poorest 20 percent, a gap of \textbf{13} percentage points. This
  gap is smaller than the typical gap across the 51 countries (19
  percentage points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_GMB} \end{flushright}
