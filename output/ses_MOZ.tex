...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Mozambique, the productivity as
  a future worker of a child born today in the richest 20 percent of
  households is \textbf{55 percent} while it is \textbf{37 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Mozambique, the
  probability of survival of a child born today in the richest 20
  percent of households is \textbf{91 percent} while it is \textbf{87
  percent} for a child born in the poorest 20 percent, a gap of
  \textbf{4} percentage points. This gap is about the same as the
  typical gap across the 51 countries (4percentage points).
\item
  \textbf{Expected Years of School.} In Mozambique, a child in the
  richest 20 percent of households who starts school at age 6 can expect
  to complete \textbf{10.9 years} of school by her 18th birthday while a
  child from the poorest 20 percent can expect to complete \textbf{6.6
...
\item
  ...
  of households in Mozambique score \textbf{395} while those from the
  poorest 20 percent score \textbf{350}, a gap of \textbf{45 points}.
  This gap is smaller than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Mozambique, the
  percentage of children in the top 20 percent of households who are not
  stunted is \textbf{76 percent} while it is \textbf{49 percent} among
  the poorest 20 percent, a gap of \textbf{27} percentage points. This
  gap is larger than the typical gap across the 51 countries (19
  percentage points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_MOZ} \end{flushright}
