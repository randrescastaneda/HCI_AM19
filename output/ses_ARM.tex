...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Armenia, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{77 percent} while it is \textbf{66 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Armenia, the probability
  of survival of a child born today in the richest 20 percent of
  households is \textbf{100 percent} while it is \textbf{99 percent} for
...
\item
  \textbf{Expected Years of School.} In Armenia, a child in the richest
  ...
  child from the poorest 20 percent can expect to complete \textbf{11.3
...
\item
  ...
  of households in Armenia score \textbf{483} while those from the
  poorest 20 percent score \textbf{417}, a gap of \textbf{67 points}.
  This gap is larger than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Armenia, the percentage
  of children in the top 20 percent of households who are not stunted is
  \textbf{94 percent} while it is \textbf{88 percent} among the poorest
  20 percent, a gap of \textbf{6} percentage points. This gap is smaller
  than the typical gap across the 51 countries (19 percentage points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_ARM} \end{flushright}
