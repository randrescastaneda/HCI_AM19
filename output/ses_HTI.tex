...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Haiti, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{58 percent} while it is \textbf{45 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Haiti, the probability
...
\item
  \textbf{Expected Years of School.} In Haiti, a child in the richest 20
  percent of households who starts school at age 6 can expect to
  complete \textbf{11.1 years} of school by her 18th birthday while a
...
\item
  ...
  of households in Haiti score \textbf{351} while those from the poorest
  20 percent score \textbf{331}, a gap of \textbf{20 points}. This gap
  is smaller than the typical gap across the 51 countries (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Haiti, the percentage
  of children in the top 20 percent of households who are not stunted is
  \textbf{94 percent} while it is \textbf{70 percent} among the poorest
...
\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_HTI} \end{flushright}
