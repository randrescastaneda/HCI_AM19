...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In India, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{61 percent} while it is \textbf{44 percent} for
  a child born in the poorest 20 percent, a gap of \textbf{17}
  percentage points. This gap is larger than the typical gap across the
  51 countries (15 percentage points).
\item
  \textbf{Probability of Survival to Age 5.} In India, the probability
  of survival of a child born today in the richest 20 percent of
  households is \textbf{98 percent} while it is \textbf{92 percent} for
  a child born in the poorest 20 percent, a gap of \textbf{5} percentage
  points. This gap is slightly larger than the typical gap across the 51
  countries (4percentage points).
\item
  \textbf{Expected Years of School.} In India, a child in the richest 20
  percent of households who starts school at age 6 can expect to
  complete \textbf{11.7 years} of school by her 18th birthday while a
  child from the poorest 20 percent can expect to complete \textbf{9.3
  years} of school, a gap of \textbf{2.4 years} of school. This gap is
  about the same as the typical gap across the 51 countries (2.4years).
\item
  \textbf{Harmonized Test Scores.} Students from the richest 20 percent
  of households in India score \textbf{383} while those from the poorest
  20 percent score \textbf{335}, a gap of \textbf{48 points}. This gap
  is smaller than the typical gap across the 51 countries (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In India, the percentage
  of children in the top 20 percent of households who are not stunted is
  \textbf{78 percent} while it is \textbf{49 percent} among the poorest
  20 percent, a gap of \textbf{29} percentage points. This gap is larger
  than the typical gap across the 51 countries (19 percentage points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_IND} \end{flushright}
