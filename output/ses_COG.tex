...
\hypersetup{unicode=true,
            pdftitle={The Republic of Congo},
...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Congo, Rep., the productivity
...
\item
  \textbf{Probability of Survival to Age 5.} In Congo, Rep., the
  probability of survival of a child born today in the richest 20
  percent of households is \textbf{97 percent} while it is \textbf{92
...
\item
  \textbf{Expected Years of School.} In Congo, Rep., a child in the
  richest 20 percent of households who starts school at age 6 can expect
  to complete \textbf{11.7 years} of school by her 18th birthday while a
  child from the poorest 20 percent can expect to complete \textbf{10.1
  years} of school, a gap of \textbf{1.6 years} of school. This gap is
...
\item
  ...
  of households in Congo, Rep.~score \textbf{410} while those from the
  poorest 20 percent score \textbf{343}, a gap of \textbf{67 points}.
  This gap is larger than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Congo, Rep., the
  percentage of children in the top 20 percent of households who are not
  stunted is \textbf{86 percent} while it is \textbf{70 percent} among
  the poorest 20 percent, a gap of \textbf{16} percentage points. This
  gap is smaller than the typical gap across the 51 countries (19
  percentage points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_COG} \end{flushright}
