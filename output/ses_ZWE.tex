...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Zimbabwe, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{66 percent} while it is \textbf{47 percent} for
  a child born in the poorest 20 percent, a gap of \textbf{19}
  percentage points. This gap is larger than the typical gap across the
  51 countries (15 percentage points).
\item
  \textbf{Probability of Survival to Age 5.} In Zimbabwe, the
...
\item
  \textbf{Expected Years of School.} In Zimbabwe, a child in the richest
  20 percent of households who starts school at age 6 can expect to
  complete \textbf{11 years} of school by her 18th birthday while a
...
\item
  ...
  of households in Zimbabwe score \textbf{462} while those from the
  poorest 20 percent score \textbf{369}, a gap of \textbf{94 points}.
  This gap is larger than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Zimbabwe, the
  percentage of children in the top 20 percent of households who are not
  stunted is \textbf{85 percent} while it is \textbf{68 percent} among
...
\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_ZWE} \end{flushright}
