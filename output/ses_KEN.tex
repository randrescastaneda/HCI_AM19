...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Kenya, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{66 percent} while it is \textbf{50 percent} for
  a child born in the poorest 20 percent, a gap of \textbf{16}
  percentage points. This gap is slightly larger than the typical gap
  across the 51 countries (15 percentage points).
\item
  \textbf{Probability of Survival to Age 5.} In Kenya, the probability
  of survival of a child born today in the richest 20 percent of
  households is \textbf{95 percent} while it is \textbf{94 percent} for
...
\item
  \textbf{Expected Years of School.} In Kenya, a child in the richest 20
  percent of households who starts school at age 6 can expect to
  complete \textbf{10.7 years} of school by her 18th birthday while a
  child from the poorest 20 percent can expect to complete \textbf{8.5
  years} of school, a gap of \textbf{2.2 years} of school. This gap is
...
\item
  ...
  of households in Kenya score \textbf{467} while those from the poorest
  20 percent score \textbf{404}, a gap of \textbf{62 points}. This gap
  is larger than the typical gap across the 51 countries (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Kenya, the percentage
  of children in the top 20 percent of households who are not stunted is
  \textbf{86 percent} while it is \textbf{64 percent} among the poorest
  20 percent, a gap of \textbf{22} percentage points. This gap is larger
  than the typical gap across the 51 countries (19 percentage points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_KEN} \end{flushright}
