...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Senegal, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{62 percent} while it is \textbf{41 percent} for
  a child born in the poorest 20 percent, a gap of \textbf{22}
  percentage points. This gap is larger than the typical gap across the
  51 countries (15 percentage points).
\item
  \textbf{Probability of Survival to Age 5.} In Senegal, the probability
  of survival of a child born today in the richest 20 percent of
  households is \textbf{97 percent} while it is \textbf{91 percent} for
...
\item
  \textbf{Expected Years of School.} In Senegal, a child in the richest
  20 percent of households who starts school at age 6 can expect to
  complete \textbf{9.6 years} of school by her 18th birthday while a
  child from the poorest 20 percent can expect to complete \textbf{5.4
  years} of school, a gap of \textbf{4.3 years} of school. This gap is
...
\item
  ...
  of households in Senegal score \textbf{440} while those from the
  poorest 20 percent score \textbf{370}, a gap of \textbf{71 points}.
  This gap is larger than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Senegal, the percentage
  of children in the top 20 percent of households who are not stunted is
  \textbf{91 percent} while it is \textbf{72 percent} among the poorest
  20 percent, a gap of \textbf{20} percentage points. This gap is
  slightly larger than the typical gap across the 51 countries (19
  percentage points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_SEN} \end{flushright}
