...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Benin, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{59 percent} while it is \textbf{37 percent} for
  a child born in the poorest 20 percent, a gap of \textbf{23}
  percentage points. This gap is larger than the typical gap across the
  51 countries (15 percentage points).
\item
  \textbf{Probability of Survival to Age 5.} In Benin, the probability
  of survival of a child born today in the richest 20 percent of
  households is \textbf{93 percent} while it is \textbf{86 percent} for
  a child born in the poorest 20 percent, a gap of \textbf{7} percentage
  points. This gap is larger than the typical gap across the 51
  countries (4percentage points).
\item
  \textbf{Expected Years of School.} In Benin, a child in the richest 20
  ...
  child from the poorest 20 percent can expect to complete \textbf{5.6
  years} of school, a gap of \textbf{4.9 years} of school. This gap is
...
\item
  ...
  of households in Benin score \textbf{423} while those from the poorest
  20 percent score \textbf{365}, a gap of \textbf{59 points}. This gap
  is about the same as the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Benin, the percentage
  of children in the top 20 percent of households who are not stunted is
  \textbf{82 percent} while it is \textbf{54 percent} among the poorest
  20 percent, a gap of \textbf{28} percentage points. This gap is larger
  than the typical gap across the 51 countries (19 percentage points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_BEN} \end{flushright}
