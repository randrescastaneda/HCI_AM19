...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Jordan, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{74 percent} while it is \textbf{60 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Jordan, the probability
  of survival of a child born today in the richest 20 percent of
  households is \textbf{99 percent} while it is \textbf{97 percent} for
  a child born in the poorest 20 percent, a gap of \textbf{2} percentage
  points. This gap is smaller than the typical gap across the 51
  countries (4percentage points).
\item
  \textbf{Expected Years of School.} In Jordan, a child in the richest
...
\item
  ...
  of households in Jordan score \textbf{448} while those from the
  poorest 20 percent score \textbf{384}, a gap of \textbf{64 points}.
  This gap is larger than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Jordan, the percentage
  of children in the top 20 percent of households who are not stunted is
  \textbf{98 percent} while it is \textbf{86 percent} among the poorest
...
\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_JOR} \end{flushright}
