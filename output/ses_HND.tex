...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Honduras, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{64 percent} while it is \textbf{44 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Honduras, the
...
\item
  \textbf{Expected Years of School.} In Honduras, a child in the richest
  ...
  years} of school, a gap of \textbf{3.5 years} of school. This gap is
...
\item
  ...
  of households in Honduras score \textbf{430} while those from the
  poorest 20 percent score \textbf{374}, a gap of \textbf{56 points}.
  This gap is about the same as the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Honduras, the
  percentage of children in the top 20 percent of households who are not
  stunted is \textbf{93 percent} while it is \textbf{58 percent} among
  the poorest 20 percent, a gap of \textbf{35} percentage points. This
  gap is larger than the typical gap across the 51 countries (19
  percentage points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_HND} \end{flushright}
