...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Dominican Republic, the
  productivity as a future worker of a child born today in the richest
  20 percent of households is \textbf{66 percent} while it is \textbf{53
...
\item
  \textbf{Probability of Survival to Age 5.} In Dominican Republic, the
...
\item
  \textbf{Expected Years of School.} In Dominican Republic, a child in
  the richest 20 percent of households who starts school at age 6 can
  expect to complete \textbf{11.4 years} of school by her 18th birthday
  while a child from the poorest 20 percent can expect to complete
  \textbf{9.9 years} of school, a gap of \textbf{1.5 years} of school.
...
\item
  ...
  of households in Dominican Republic score \textbf{398} while those
  from the poorest 20 percent score \textbf{322}, a gap of \textbf{75
  points}. This gap is larger than the typical gap across the 51
  countries (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Dominican Republic, the
  percentage of children in the top 20 percent of households who are not
  stunted is \textbf{96 percent} while it is \textbf{89 percent} among
...
\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_DOM} \end{flushright}
