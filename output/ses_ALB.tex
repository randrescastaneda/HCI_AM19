...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Albania, the productivity as a
...
\item
  \textbf{Probability of Survival to Age 5.} In Albania, the probability
...
\item
  \textbf{Expected Years of School.} In Albania, a child in the richest
...
\item
  ...
  of households in Albania score \textbf{437} while those from the
  poorest 20 percent score \textbf{356}, a gap of \textbf{81 points}.
  This gap is larger than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Albania, the percentage
  of children in the top 20 percent of households who are not stunted is
  \textbf{87 percent} while it is \textbf{73 percent} among the poorest
  20 percent, a gap of \textbf{13} percentage points. This gap is
  smaller than the typical gap across the 51 countries (19 percentage
  points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_ALB} \end{flushright}
