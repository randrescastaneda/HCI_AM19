...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Uganda, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{55 percent} while it is \textbf{45 percent} for
  a child born in the poorest 20 percent, a gap of \textbf{10}
  percentage points. This gap is smaller than the typical gap across the
  51 countries (15 percentage points).
\item
  \textbf{Probability of Survival to Age 5.} In Uganda, the probability
  of survival of a child born today in the richest 20 percent of
  households is \textbf{95 percent} while it is \textbf{91 percent} for
...
\item
  \textbf{Expected Years of School.} In Uganda, a child in the richest
  20 percent of households who starts school at age 6 can expect to
  complete \textbf{9.5 years} of school by her 18th birthday while a
  child from the poorest 20 percent can expect to complete \textbf{8.3
...
\item
  ...
  of households in Uganda score \textbf{399} while those from the
  poorest 20 percent score \textbf{355}, a gap of \textbf{44 points}.
  This gap is smaller than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Uganda, the percentage
  of children in the top 20 percent of households who are not stunted is
  \textbf{83 percent} while it is \textbf{67 percent} among the poorest
  20 percent, a gap of \textbf{16} percentage points. This gap is
  smaller than the typical gap across the 51 countries (19 percentage
  points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_UGA} \end{flushright}
