...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Côte d'Ivoire, the productivity
  as a future worker of a child born today in the richest 20 percent of
  households is \textbf{58 percent} while it is \textbf{40 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Côte d'Ivoire, the
  probability of survival of a child born today in the richest 20
  percent of households is \textbf{93 percent} while it is \textbf{88
...
\item
  \textbf{Expected Years of School.} In Côte d'Ivoire, a child in the
  richest 20 percent of households who starts school at age 6 can expect
  to complete \textbf{10 years} of school by her 18th birthday while a
  child from the poorest 20 percent can expect to complete \textbf{6.2
  years} of school, a gap of \textbf{3.8 years} of school. This gap is
...
\item
  ...
  of households in Côte d'Ivoire score \textbf{400} while those from the
  poorest 20 percent score \textbf{350}, a gap of \textbf{50 points}.
  This gap is smaller than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Côte d'Ivoire, the
...
\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_CIV} \end{flushright}
