...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Turkey, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{77 percent} while it is \textbf{49 percent} for
  a child born in the poorest 20 percent, a gap of \textbf{29}
  percentage points. This gap is larger than the typical gap across the
  51 countries (15 percentage points).
\item
  \textbf{Probability of Survival to Age 5.} In Turkey, the probability
...
\item
  \textbf{Expected Years of School.} In Turkey, a child in the richest
  ...
  child from the poorest 20 percent can expect to complete \textbf{7.9
  years} of school, a gap of \textbf{3.2 years} of school. This gap is
...
\item
  ...
  of households in Turkey score \textbf{521} while those from the
  poorest 20 percent score \textbf{426}, a gap of \textbf{94 points}.
  This gap is larger than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Turkey, the percentage
  of children in the top 20 percent of households who are not stunted is
  \textbf{96 percent} while it is \textbf{69 percent} among the poorest
  20 percent, a gap of \textbf{27} percentage points. This gap is larger
  than the typical gap across the 51 countries (19 percentage points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_TUR} \end{flushright}
