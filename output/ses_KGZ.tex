...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Kyrgyz Republic, the
  productivity as a future worker of a child born today in the richest
  20 percent of households is \textbf{62 percent} while it is \textbf{52
  percent} for a child born in the poorest 20 percent, a gap of
  \textbf{10} percentage points. This gap is smaller than the typical
  gap across the 51 countries (15 percentage points).
\item
  \textbf{Probability of Survival to Age 5.} In Kyrgyz Republic, the
  probability of survival of a child born today in the richest 20
  percent of households is \textbf{99 percent} while it is \textbf{96
  percent} for a child born in the poorest 20 percent, a gap of
  \textbf{3} percentage points. This gap is slightly smaller than the
  typical gap across the 51 countries (4percentage points).
\item
  \textbf{Expected Years of School.} In Kyrgyz Republic, a child in the
  richest 20 percent of households who starts school at age 6 can expect
  to complete \textbf{10.6 years} of school by her 18th birthday while a
  child from the poorest 20 percent can expect to complete \textbf{10.7
  years} of school, a gap of \textbf{0 years} of school. This gap is
...
\item
  ...
  of households in Kyrgyz Republic score \textbf{390} while those from
  the poorest 20 percent score \textbf{296}, a gap of \textbf{94
  points}. This gap is larger than the typical gap across the 51
  countries (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Kyrgyz Republic, the
  percentage of children in the top 20 percent of households who are not
  stunted is \textbf{89 percent} while it is \textbf{82 percent} among
  the poorest 20 percent, a gap of \textbf{7} percentage points. This
  gap is smaller than the typical gap across the 51 countries (19
  percentage points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_KGZ} \end{flushright}
