...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Malawi, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{54 percent} while it is \textbf{45 percent} for
  a child born in the poorest 20 percent, a gap of \textbf{9} percentage
  points. This gap is smaller than the typical gap across the 51
  countries (15 percentage points).
\item
  \textbf{Probability of Survival to Age 5.} In Malawi, the probability
  of survival of a child born today in the richest 20 percent of
  households is \textbf{94 percent} while it is \textbf{92 percent} for
...
\item
  \textbf{Expected Years of School.} In Malawi, a child in the richest
  ...
  years} of school, a gap of \textbf{1.5 years} of school. This gap is
...
\item
  ...
  of households in Malawi score \textbf{338} while those from the
  poorest 20 percent score \textbf{325}, a gap of \textbf{13 points}.
  This gap is smaller than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Malawi, the percentage
  of children in the top 20 percent of households who are not stunted is
  \textbf{77 percent} while it is \textbf{55 percent} among the poorest
...
\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_MWI} \end{flushright}
