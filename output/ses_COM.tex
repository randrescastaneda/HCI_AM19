...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Comoros, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{49 percent} while it is \textbf{35 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Comoros, the probability
  of survival of a child born today in the richest 20 percent of
  households is \textbf{91 percent} while it is \textbf{87 percent} for
  a child born in the poorest 20 percent, a gap of \textbf{4} percentage
  points. This gap is about the same as the typical gap across the 51
  countries (4percentage points).
\item
  \textbf{Expected Years of School.} In Comoros, a child in the richest
  20 percent of households who starts school at age 6 can expect to
  complete \textbf{9 years} of school by her 18th birthday while a child
  from the poorest 20 percent can expect to complete \textbf{4.6 years}
  of school, a gap of \textbf{4.4 years} of school. This gap is larger
  than the typical gap across the 51 countries (2.4years).
\item
  \textbf{Harmonized Test Scores.} Students from the richest 20 percent
  of households in Comoros score \textbf{408} while those from the
  poorest 20 percent score \textbf{376}, a gap of \textbf{33 points}.
  This gap is smaller than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Comoros, the percentage
  of children in the top 20 percent of households who are not stunted is
  \textbf{61 percent} while it is \textbf{50 percent} among the poorest
  20 percent, a gap of \textbf{11} percentage points. This gap is
  smaller than the typical gap across the 51 countries (19 percentage
  points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_COM} \end{flushright}
