...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Namibia, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{65 percent} while it is \textbf{49 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Namibia, the probability
  of survival of a child born today in the richest 20 percent of
  households is \textbf{97 percent} while it is \textbf{93 percent} for
...
\item
  \textbf{Expected Years of School.} In Namibia, a child in the richest
  20 percent of households who starts school at age 6 can expect to
  complete \textbf{10.8 years} of school by her 18th birthday while a
  child from the poorest 20 percent can expect to complete \textbf{9.4
  years} of school, a gap of \textbf{1.4 years} of school. This gap is
...
\item
  ...
  of households in Namibia score \textbf{427} while those from the
  poorest 20 percent score \textbf{346}, a gap of \textbf{81 points}.
  This gap is larger than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Namibia, the percentage
  of children in the top 20 percent of households who are not stunted is
  \textbf{90 percent} while it is \textbf{71 percent} among the poorest
  20 percent, a gap of \textbf{20} percentage points. This gap is about
  the same as the typical gap across the 51 countries (19 percentage
  points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_NAM} \end{flushright}
