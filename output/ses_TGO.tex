...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Togo, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{63 percent} while it is \textbf{45 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Togo, the probability of
  ...
  born in the poorest 20 percent, a gap of \textbf{7} percentage points.
  This gap is larger than the typical gap across the 51 countries
  (4percentage points).
\item
  \textbf{Expected Years of School.} In Togo, a child in the richest 20
  percent of households who starts school at age 6 can expect to
  complete \textbf{10.6 years} of school by her 18th birthday while a
  child from the poorest 20 percent can expect to complete \textbf{8.9
  years} of school, a gap of \textbf{1.8 years} of school. This gap is
...
\item
  ...
  of households in Togo score \textbf{425} while those from the poorest
  20 percent score \textbf{356}, a gap of \textbf{69 points}. This gap
  is larger than the typical gap across the 51 countries (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Togo, the percentage of
  children in the top 20 percent of households who are not stunted is
  \textbf{90 percent} while it is \textbf{67 percent} among the poorest
  20 percent, a gap of \textbf{23} percentage points. This gap is larger
  than the typical gap across the 51 countries (19 percentage points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_TGO} \end{flushright}
