...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Gabon, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{71 percent} while it is \textbf{57 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Gabon, the probability
  of survival of a child born today in the richest 20 percent of
  households is \textbf{95 percent} while it is \textbf{92 percent} for
...
\item
  \textbf{Expected Years of School.} In Gabon, a child in the richest 20
  percent of households who starts school at age 6 can expect to
  complete \textbf{11.3 years} of school by her 18th birthday while a
  child from the poorest 20 percent can expect to complete \textbf{10.4
  years} of school, a gap of \textbf{1 years} of school. This gap is
...
\item
  ...
  of households in Gabon score \textbf{474} while those from the poorest
  20 percent score \textbf{434}, a gap of \textbf{40 points}. This gap
  is smaller than the typical gap across the 51 countries (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Gabon, the percentage
  of children in the top 20 percent of households who are not stunted is
  \textbf{95 percent} while it is \textbf{70 percent} among the poorest
  20 percent, a gap of \textbf{24} percentage points. This gap is larger
  than the typical gap across the 51 countries (19 percentage points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_GAB} \end{flushright}
