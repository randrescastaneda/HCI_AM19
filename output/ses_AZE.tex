...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Azerbaijan, the productivity as
  a future worker of a child born today in the richest 20 percent of
  households is \textbf{65 percent} while it is \textbf{54 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Azerbaijan, the
...
\item
  \textbf{Expected Years of School.} In Azerbaijan, a child in the
  richest 20 percent of households who starts school at age 6 can expect
  to complete \textbf{11 years} of school by her 18th birthday while a
...
\item
  ...
  of households in Azerbaijan score \textbf{441} while those from the
  poorest 20 percent score \textbf{410}, a gap of \textbf{31 points}.
  This gap is smaller than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Azerbaijan, the
  percentage of children in the top 20 percent of households who are not
  stunted is \textbf{84 percent} while it is \textbf{67 percent} among
  the poorest 20 percent, a gap of \textbf{17} percentage points. This
  gap is smaller than the typical gap across the 51 countries (19
  percentage points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_AZE} \end{flushright}
