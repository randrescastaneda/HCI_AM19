...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Guatemala, the productivity as
  a future worker of a child born today in the richest 20 percent of
  households is \textbf{62 percent} while it is \textbf{40 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Guatemala, the
  probability of survival of a child born today in the richest 20
  percent of households is \textbf{98 percent} while it is \textbf{94
...
\item
  \textbf{Expected Years of School.} In Guatemala, a child in the
  richest 20 percent of households who starts school at age 6 can expect
  to complete \textbf{9.8 years} of school by her 18th birthday while a
  child from the poorest 20 percent can expect to complete \textbf{6.8
  years} of school, a gap of \textbf{3 years} of school. This gap is
...
\item
  ...
  of households in Guatemala score \textbf{449} while those from the
  poorest 20 percent score \textbf{377}, a gap of \textbf{72 points}.
  This gap is larger than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Guatemala, the
  percentage of children in the top 20 percent of households who are not
  stunted is \textbf{82 percent} while it is \textbf{34 percent} among
  the poorest 20 percent, a gap of \textbf{48} percentage points. This
  gap is larger than the typical gap across the 51 countries (19
  percentage points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_GTM} \end{flushright}
