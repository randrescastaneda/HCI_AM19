...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Chad, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{45 percent} while it is \textbf{35 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Chad, the probability of
  survival of a child born today in the richest 20 percent of households
  is \textbf{86 percent} while it is \textbf{84 percent} for a child
  ...
  (4percentage points).
\item
  \textbf{Expected Years of School.} In Chad, a child in the richest 20
  ...
  child from the poorest 20 percent can expect to complete \textbf{5.4
...
\item
  ...
  of households in Chad score \textbf{357} while those from the poorest
  20 percent score \textbf{322}, a gap of \textbf{35 points}. This gap
  is smaller than the typical gap across the 51 countries (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Chad, the percentage of
  children in the top 20 percent of households who are not stunted is
  \textbf{68 percent} while it is \textbf{59 percent} among the poorest
  20 percent, a gap of \textbf{9} percentage points. This gap is smaller
  than the typical gap across the 51 countries (19 percentage points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_TCD} \end{flushright}
