...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Tanzania, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{54 percent} while it is \textbf{39 percent} for
  a child born in the poorest 20 percent, a gap of \textbf{15}
  percentage points. This gap is about the same as the typical gap
  across the 51 countries (15 percentage points).
\item
  \textbf{Probability of Survival to Age 5.} In Tanzania, the
  probability of survival of a child born today in the richest 20
  percent of households is \textbf{93 percent} while it is \textbf{92
  percent} for a child born in the poorest 20 percent, a gap of
  \textbf{0} percentage points. This gap is smaller than the typical gap
  across the 51 countries (4percentage points).
\item
  \textbf{Expected Years of School.} In Tanzania, a child in the richest
  ...
  years} of school, a gap of \textbf{3.9 years} of school. This gap is
...
\item
  ...
  of households in Tanzania score \textbf{407} while those from the
  poorest 20 percent score \textbf{331}, a gap of \textbf{76 points}.
  This gap is larger than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Tanzania, the
  percentage of children in the top 20 percent of households who are not
  stunted is \textbf{81 percent} while it is \textbf{61 percent} among
  the poorest 20 percent, a gap of \textbf{20} percentage points. This
  gap is slightly larger than the typical gap across the 51 countries
  (19 percentage points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_TZA} \end{flushright}
