...
\hypersetup{unicode=true,
            pdftitle={The Democratic Republic of Congo},
...
\setlength{\droptitle}{-2em}
  ...
  \title{The Democratic Republic of Congo}
...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Congo, Dem. Rep., the
  productivity as a future worker of a child born today in the richest
  20 percent of households is \textbf{52 percent} while it is \textbf{40
...
\item
  \textbf{Probability of Survival to Age 5.} In Congo, Dem. Rep., the
  probability of survival of a child born today in the richest 20
  percent of households is \textbf{92 percent} while it is \textbf{88
  percent} for a child born in the poorest 20 percent, a gap of
  \textbf{4} percentage points. This gap is about the same as the
  typical gap across the 51 countries (4percentage points).
\item
  \textbf{Expected Years of School.} In Congo, Dem. Rep., a child in the
  richest 20 percent of households who starts school at age 6 can expect
  to complete \textbf{10.8 years} of school by her 18th birthday while a
...
\item
  ...
  of households in Congo, Dem. Rep.~score \textbf{326} while those from
  the poorest 20 percent score \textbf{311}, a gap of \textbf{16
  points}. This gap is smaller than the typical gap across the 51
  countries (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Congo, Dem. Rep., the
  percentage of children in the top 20 percent of households who are not
  stunted is \textbf{79 percent} while it is \textbf{50 percent} among
  the poorest 20 percent, a gap of \textbf{30} percentage points. This
  gap is larger than the typical gap across the 51 countries (19
  percentage points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_COD} \end{flushright}
