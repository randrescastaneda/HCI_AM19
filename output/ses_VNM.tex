...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Vietnam, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{85 percent} while it is \textbf{58 percent} for
  a child born in the poorest 20 percent, a gap of \textbf{27}
  percentage points. This gap is larger than the typical gap across the
  51 countries (15 percentage points).
\item
  \textbf{Probability of Survival to Age 5.} In Vietnam, the probability
  of survival of a child born today in the richest 20 percent of
  households is \textbf{99 percent} while it is \textbf{96 percent} for
...
\item
  \textbf{Expected Years of School.} In Vietnam, a child in the richest
  20 percent of households who starts school at age 6 can expect to
  complete \textbf{11.6 years} of school by her 18th birthday while a
  child from the poorest 20 percent can expect to complete \textbf{9.6
  years} of school, a gap of \textbf{2.1 years} of school. This gap is
...
\item
  ...
  of households in Vietnam score \textbf{560} while those from the
  poorest 20 percent score \textbf{487}, a gap of \textbf{73 points}.
  This gap is larger than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Vietnam, the percentage
  of children in the top 20 percent of households who are not stunted is
  \textbf{94 percent} while it is \textbf{59 percent} among the poorest
...
\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_VNM} \end{flushright}
