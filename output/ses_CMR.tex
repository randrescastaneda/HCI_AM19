...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Cameroon, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{63 percent} while it is \textbf{38 percent} for
  a child born in the poorest 20 percent, a gap of \textbf{26}
  percentage points. This gap is larger than the typical gap across the
  51 countries (15 percentage points).
\item
  \textbf{Probability of Survival to Age 5.} In Cameroon, the
  probability of survival of a child born today in the richest 20
  percent of households is \textbf{94 percent} while it is \textbf{83
  percent} for a child born in the poorest 20 percent, a gap of
  \textbf{12} percentage points. This gap is larger than the typical gap
  across the 51 countries (4percentage points).
\item
  \textbf{Expected Years of School.} In Cameroon, a child in the richest
...
\item
  ...
  of households in Cameroon score \textbf{418} while those from the
  poorest 20 percent score \textbf{336}, a gap of \textbf{82 points}.
  This gap is larger than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Cameroon, the
  percentage of children in the top 20 percent of households who are not
  stunted is \textbf{86 percent} while it is \textbf{58 percent} among
...
\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_CMR} \end{flushright}
