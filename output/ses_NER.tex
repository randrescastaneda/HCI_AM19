...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Niger, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{41 percent} while it is \textbf{31 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Niger, the probability
  of survival of a child born today in the richest 20 percent of
  households is \textbf{89 percent} while it is \textbf{86 percent} for
  a child born in the poorest 20 percent, a gap of \textbf{3} percentage
  points. This gap is slightly smaller than the typical gap across the
  51 countries (4percentage points).
\item
  \textbf{Expected Years of School.} In Niger, a child in the richest 20
  percent of households who starts school at age 6 can expect to
  complete \textbf{7.5 years} of school by her 18th birthday while a
  child from the poorest 20 percent can expect to complete \textbf{2.6
  years} of school, a gap of \textbf{5 years} of school. This gap is
...
\item
  ...
  of households in Niger score \textbf{321} while those from the poorest
  20 percent score \textbf{281}, a gap of \textbf{40 points}. This gap
  is smaller than the typical gap across the 51 countries (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Niger, the percentage
  of children in the top 20 percent of households who are not stunted is
  \textbf{66 percent} while it is \textbf{54 percent} among the poorest
  20 percent, a gap of \textbf{12} percentage points. This gap is
  smaller than the typical gap across the 51 countries (19 percentage
  points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_NER} \end{flushright}
