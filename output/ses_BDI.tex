...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Burundi, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{51 percent} while it is \textbf{37 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Burundi, the probability
  of survival of a child born today in the richest 20 percent of
  households is \textbf{92 percent} while it is \textbf{85 percent} for
...
\item
  \textbf{Expected Years of School.} In Burundi, a child in the richest
  ...
  child from the poorest 20 percent can expect to complete \textbf{7.1
  years} of school, a gap of \textbf{2.3 years} of school. This gap is
...
\item
  ...
  of households in Burundi score \textbf{430} while those from the
  poorest 20 percent score \textbf{422}, a gap of \textbf{8 points}.
  This gap is smaller than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Burundi, the percentage
  of children in the top 20 percent of households who are not stunted is
  \textbf{59 percent} while it is \textbf{31 percent} among the poorest
...
\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_BDI} \end{flushright}
