...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Colombia, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{69 percent} while it is \textbf{53 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Colombia, the
...
\item
  \textbf{Expected Years of School.} In Colombia, a child in the richest
  20 percent of households who starts school at age 6 can expect to
  complete \textbf{10.5 years} of school by her 18th birthday while a
...
\item
  ...
  of households in Colombia score \textbf{464} while those from the
  poorest 20 percent score \textbf{366}, a gap of \textbf{98 points}.
  This gap is larger than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Colombia, the
  percentage of children in the top 20 percent of households who are not
  stunted is \textbf{93 percent} while it is \textbf{80 percent} among
...
\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_COL} \end{flushright}
