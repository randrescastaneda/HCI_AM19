...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Brazil, the productivity as a
  future worker of a child born today in the richest 20 percent of
  households is \textbf{70 percent} while it is \textbf{47 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Brazil, the probability
...
\item
  \textbf{Expected Years of School.} In Brazil, a child in the richest
...
\item
  ...
  of households in Brazil score \textbf{442} while those from the
  poorest 20 percent score \textbf{340}, a gap of \textbf{102 points}.
  This gap is larger than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Brazil, the percentage
  of children in the top 20 percent of households who are not stunted is
  \textbf{97 percent} while it is \textbf{73 percent} among the poorest
...
\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_BRA} \end{flushright}
