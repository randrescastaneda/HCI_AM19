...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Burkina Faso, the productivity
  as a future worker of a child born today in the richest 20 percent of
  households is \textbf{52 percent} while it is \textbf{32 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Burkina Faso, the
  probability of survival of a child born today in the richest 20
  percent of households is \textbf{90 percent} while it is \textbf{83
  percent} for a child born in the poorest 20 percent, a gap of
  \textbf{8} percentage points. This gap is larger than the typical gap
  across the 51 countries (4percentage points).
\item
  \textbf{Expected Years of School.} In Burkina Faso, a child in the
  richest 20 percent of households who starts school at age 6 can expect
  to complete \textbf{8.5 years} of school by her 18th birthday while a
  child from the poorest 20 percent can expect to complete \textbf{2.9
  years} of school, a gap of \textbf{5.6 years} of school. This gap is
...
\item
  ...
  of households in Burkina Faso score \textbf{421} while those from the
  poorest 20 percent score \textbf{390}, a gap of \textbf{30 points}.
  This gap is smaller than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Burkina Faso, the
  percentage of children in the top 20 percent of households who are not
  stunted is \textbf{82 percent} while it is \textbf{58 percent} among
  the poorest 20 percent, a gap of \textbf{25} percentage points. This
  gap is larger than the typical gap across the 51 countries (19
  percentage points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_BFA} \end{flushright}
