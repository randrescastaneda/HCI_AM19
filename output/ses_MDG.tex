...
\begin{itemize}
\item
  \textbf{Human Capital Index (HCI).} In Madagascar, the productivity as
  a future worker of a child born today in the richest 20 percent of
  households is \textbf{58 percent} while it is \textbf{41 percent} for
...
\item
  \textbf{Probability of Survival to Age 5.} In Madagascar, the
  probability of survival of a child born today in the richest 20
  percent of households is \textbf{95 percent} while it is \textbf{89
  percent} for a child born in the poorest 20 percent, a gap of
  \textbf{6} percentage points. This gap is larger than the typical gap
  across the 51 countries (4percentage points).
\item
  \textbf{Expected Years of School.} In Madagascar, a child in the
  richest 20 percent of households who starts school at age 6 can expect
  to complete \textbf{10.4 years} of school by her 18th birthday while a
  child from the poorest 20 percent can expect to complete \textbf{6.2
  years} of school, a gap of \textbf{4.2 years} of school. This gap is
...
\item
  ...
  of households in Madagascar score \textbf{467} while those from the
  poorest 20 percent score \textbf{427}, a gap of \textbf{41 points}.
  This gap is smaller than the typical gap across the 51 countries
  (56points).
\item
  \textbf{Healthy Growth (Not Stunted Rate).} In Madagascar, the
  percentage of children in the top 20 percent of households who are not
  stunted is \textbf{56 percent} while it is \textbf{52 percent} among
  the poorest 20 percent, a gap of \textbf{4} percentage points. This
  gap is smaller than the typical gap across the 51 countries (19
  percentage points).
\end{itemize}

\begin{flushright}\includegraphics[width=1\linewidth]{charts/ses_MDG} \end{flushright}
